...
data CardanoTracerHandle = CardanoTracerHandle
  { inChan               ::  InChan (CardanoTracerMessage ())
  , outChan              :: OutChan (CardanoTracerMessage ())
  }

cleanupCardanoTracer :: CardanoTracerHandle -> IO ()
